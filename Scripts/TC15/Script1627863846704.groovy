...
WebUI.verifyElementText(findTestObject('Object Repository/Pastebin_OR/Page_Pastebin.com - 1 paste tool since 2002/div_Not Found (404)'),'Not Found (#404)')

WebUI.verifyElementText(findTestObject('Object Repository/Pastebin_OR/Page_Pastebin.com - 1 paste tool since 2002/div_This page is no longer available. It has either expired, been removed by its creator, or removed by one of the Pastebin staff'),'This page is no longer available. It has either expired, been removed by its creator, or removed by one of the Pastebin staff.')
