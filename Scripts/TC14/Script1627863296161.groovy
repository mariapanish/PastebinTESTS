...
WebUI.click(findTestObject('Object Repository/Pastebin_OR/Page_Pastebin.com - 1 paste tool since 2002/button_Unlock The Paste'))

WebUI.verifyElementText(findTestObject('Object Repository/Pastebin_OR/Page_Pastebin.com - 1 paste tool since 2002/textarea_dd'),'<!DOCTYPE html> <head><title>Page Title</title></head> <h1>This is a heading</h1> <p>This is a paragraph.</p>')

WebUI.verifyElementText(findTestObject('Object Repository/Pastebin_OR/Page_Pastebin.com - 1 paste tool since 2002/h1_dada'),'First Paste')

WebUI.verifyElementText(findTestObject('Object Repository/Pastebin_OR/Page_Pastebin.com - 1 paste tool since 2002/a_HTML'),'HTML')